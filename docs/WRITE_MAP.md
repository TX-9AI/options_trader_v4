...
| `plan_check` | `strategy/plan.py` | `strategy/plan.py` (insert) | `tests/check_chain_ordering.py`, `tests/check_plan_prepares.py`, `tests/check_plan_wiring.py` |
| `plan_tick` | `strategy/plan.py` | `strategy/plan.py` (insert) | `main.py`, `query.py`, `tests/check_butterfly_legs.py`, `tests/check_chain_ordering.py`, `tests/check_management_plan.py`, `tests/check_plan_prepares.py`, `tests/check_plan_signal.py`, `tests/check_plan_wiring.py` |
