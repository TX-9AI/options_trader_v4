...
- **No writer** (0): none
- **No external reader** (14): `chain_subs_aux`, `character_axis_sample`, `character_ledger`, `circuit_breaker_events`, `exit_counterfactual`, `fire_snapshot`, `indicator_series`, `last_trade`, `plan_ledger`, `session_summary`, `strategy_note`, `surface_series`, `theo_series`, `underlying_series`
