...
297 Python modules across 13 local packages.

**Reached by:** 101 imported · 9 declared entry points · 127 referenced from a script, unit or doc but never imported · **60 by nothing here**.
...
| `execution/exit_engine.py` | 13 | check_condor_spec.py, check_condor_stop_suppression.py, check_exit_executes.py, check_ladder_wired.py |
...
- **calls:** (none)
- **called by:** `execution/entry_engine.py`, `main.py`, `tests/check_absent_not_zero.py`
...
- **called by:** `execution/entry_engine.py`, `execution/position_manager.py`, `execution/resting_orders.py`, `main.py`, `strategy/base_strategy.py`, `strategy/orb_strategy.py`, `tests/check_absent_not_zero.py`, `tests/check_atr_units.py`, `tests/check_orb_one_order.py`, `tests/check_orb_rearm_zone.py`, `tests/check_orb_restart.py`, `tests/check_orb_resume.py`, `tests/check_orb_sequence.py`, `tests/check_orb_underwater_entry.py`, `tests/check_plan_signal.py`, `tests/check_standing_offer.py`
...
### `data/disk_watch.py`
- **calls:** (none)
- **called by:** `main.py`, `tests/check_disk_watch.py`
...
- **calls:** `config.py`
- **called by:** `main.py`, `notifications/alert_manager.py`
...
- **calls:** `analysis/market_state.py`, `analysis/orb_engine.py`, `analysis/volatility_engine.py`, `config.py`, `data/macro_data.py`, `data/options_chain.py`, `strategy/base_strategy.py`, `strategy/plan.py`
- **called by:** `main.py`, `tests/check_absent_not_zero.py`, `tests/check_atr_units.py`, `tests/check_orb_one_order.py`, `tests/check_orb_sequence.py`, `tests/check_orb_underwater_entry.py`, `tests/check_plan_signal.py`
...
### `strategy/relaxed.py`
- **calls:** `config.py`
- **called by:** `strategy/criteria.py`, `strategy/runaway_continuation.py`, `strategy/sweep_credit_spread.py`, `tests/check_entry_windows.py`, `tests/stress_entry_path.py`
...
- **called by:** `main.py`, `tests/check_entry_windows.py`, `tests/check_plan_prepares.py`, `tests/check_tcs_fifty.py`, `tests/check_tcs_narrates.py`, `tests/check_tcs_parked.py`
...
### `tests/check_absent_not_zero.py`
- **calls:** `analysis/level_grade.py`, `analysis/orb_engine.py`, `strategy/base_strategy.py`, `strategy/orb_strategy.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_doc_menu_refs.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`, `install.sh`
...
### `tests/check_entry_records_contract.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_exit_credit_side.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_gex_from_chains.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_orb_stop_respected.py`
- **calls:** `config.py`, `execution/exit_engine.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`

### `tests/check_orb_underwater_entry.py`
- **calls:** `analysis/orb_engine.py`, `execution/exit_engine.py`, `risk/risk_manager.py`, `strategy/__init__.py`, `strategy/orb_strategy.py`, `strategy/plan.py`, `utils/time_utils.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_purge_batched.py`
- **calls:** `warehouse/retention_purge.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_tcs_records_best_r.py`
- **calls:** (none)
- **called by:** (nothing — no importer and no mention in any script, unit or doc here)

### `tests/check_tcs_wing_study.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`, `docs/ROADMAP.md`
...
- **calls:** (none)
- **called by:** `tests/check_purge_batched.py`, `tests/check_purge_lock.py`, `tests/check_purge_pushed.py`, `tests/check_purge_reclaim.py`, `tests/check_push_row_day.py`, `tests/check_retention_armed.py`, `warehouse/self_close.py`
